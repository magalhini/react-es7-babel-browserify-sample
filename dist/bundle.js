...
var Item = (function (_React$Component) {
	...
	function Item() {
		...
		_this.findBatman = _this.findBatman.bind(_this);

		// Equivalent to default state
		_this.state = { hasBatman: false };
		return _this;
	}
	...
	_createClass(Item, [{
		key: 'findBatman',
		value: function findBatman() {
			var batmanFound = _utils2.default.data.filter(function (item) {
				return item === 'found batman!';
			});
		...
		value: function render() {
			...
			var hasBatman = this.state.hasBatman;

			var text = hasBatman ? 'We found Batman!' : 'Where is Batman?';
			var disabled = !!hasBatman;
			var buttonText = hasBatman ? 'He was found' : 'Find Batman!';
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ disabled: disabled, onClick: this.findBatman },
					buttonText
				)
			);
		}
...
_reactDom2.default.render(_react2.default.createElement(Item, null), document.getElementById('app'));

},{"./utils":160,"react":158,"react-dom":2}],160:[function(require,module,exports){
'use strict';
...
var utils = {
	...
	data: ['not batman', 'found batman!', 'not batman']
};
